...
const j = {
  ...
  llmProvider: (process.env.LLM_PROVIDER || "ollama").toLowerCase() === "featherless" ? "featherless" : "ollama",
  llmModel:
    (process.env.LLM_MODEL || process.env.OLLAMA_MODEL || process.env.FEATHERLESS_MODEL || "qwen3:8b").trim(),
